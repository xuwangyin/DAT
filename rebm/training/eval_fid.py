...
from rebm.training.eval_utils import evaluate_image_generation
...
def main(argv: list[str] | None = None) -> float:
    ...
    if not args or "-h" in args or "--help" in args:
        ...
        print("\nUsage: python -m rebm.training.eval_fid CONFIG_FILE [KEY=VALUE ...]")
        print("\nExamples:")
        print("  python -m rebm.training.eval_fid experiments/cifar10/eval_fid/config.yaml")
        print("  python -m rebm.training.eval_fid experiments/cifar10/config.yaml model.ckpt_path=/path/to/model.pth")
        sys.exit(0)
