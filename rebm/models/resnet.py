# https://github.com/MadryLab/robustness/blob/master/robustness/imagenet_models/resnet.py
import torch
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, normalize_input: bool = True, use_batchnorm: bool = False):
    ...
    def _forward(self, x, y=None, with_latent=False, fake_relu=False, no_relu=False):
